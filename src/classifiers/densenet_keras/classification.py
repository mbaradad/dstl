...
from classifiers.resnet_keras.train_classification import transform_to_classification

def create_model():
  net = Network(input_shape=(20, 224, 224), n_layers_per_block=[4, 5, 7, 10, 12, 15, 12, 10, 7, 5, 3], n_pool=5, growth_rate=16, chunk_size=3)
...
if __name__ == "__main__":
  ...
  with sess.as_default():
    ...
    generator_train = transform_to_classification(d.cropped_generator(chunk_size=3, crop_size=(224,224), overlapping_percentage=0.25, subset='train'))
    generator_val = transform_to_classification(d.cropped_generator(chunk_size=3, crop_size=(224,224), overlapping_percentage=0.25, subset='val'))
